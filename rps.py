...
class PS(object):
    ...
    def solve(self):
        ...
        print(self.M.shape, self.L.shape)
        ...
        print(self.M.T.shape, self.L.T.shape)
        regressor.fit(self.L.T, self.M.T)

        self.N = regressor.coef_
        print(self.M.T.shape, self.L.T.shape, self.N.T.shape)
